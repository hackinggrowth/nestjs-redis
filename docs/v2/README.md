...
```sh
$ npm install --save @hackinggrowth/nestjs-redis@next ioredis @nestjs/terminus@next
$ npm install --save-dev @types/ioredis
```

```sh
$ yarn add @hackinggrowth/nestjs-redis@next ioredis @nestjs/terminus@next
...
```sh
$ npm install --save @hackinggrowth/nestjs-redis@2 ioredis @nestjs/terminus@7
$ npm install --save-dev @types/ioredis
```

```sh
$ yarn add @hackinggrowth/nestjs-redis@2 ioredis @nestjs/terminus@7
$ yarn add --dev @types/ioredis
```
...
import { InjectRedis, DEFAULT_REDIS_CLIENT } from '@hackinggrowth/nestjs-redis';
...
import { Injectable } from '@nestjs/common';
import { Redis } from 'ioredis';
import { DEFAULT_REDIS_CLIENT, RedisService } from '@hackinggrowth/nestjs-redis';
...
import { RedisHealthIndicator, DEFAULT_REDIS_CLIENT } from '@hackinggrowth/nestjs-redis';
...
import { InjectCluster, DEFAULT_CLUSTER_CLIENT } from '@hackinggrowth/nestjs-redis';
...
import { Injectable } from '@nestjs/common';
import { Cluster } from 'ioredis';
import { DEFAULT_CLUSTER_CLIENT, ClusterService } from '@hackinggrowth/nestjs-redis';
...
import { Controller, Get } from '@nestjs/common';
import { HealthCheckService, HealthCheckResult } from '@nestjs/terminus';
import { ClusterHealthIndicator, DEFAULT_CLUSTER_CLIENT } from '@hackinggrowth/nestjs-redis';
...
- Github: [@hackinggrowth](https://github.com/liaoliaots)
