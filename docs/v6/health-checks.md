...
import { RedisHealthModule } from '@hackinggrowth/nestjs-redis/health'; // note the path
...
import { RedisHealthIndicator } from '@hackinggrowth/nestjs-redis/health'; // note the path
